...
public class RemoveLeverandor extends JDialog {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1351626622843849892L;
	private final JPanel contentPanel = new JPanel();
	private JPanel buttonPane;
	JList<Leverandor> listSolgt;
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
					 	...
					 	try{
							...
							MainFrame.getLeverandorList().remove(listSolgt.getSelectedIndex());
							dispose();
						}
						catch(Exception ex){
	...
	//			JList<Leverandor> listSolgt = new JList();
				// Comment this out to use the designer.
		listSolgt = new JList<Leverandor>(levArray);
