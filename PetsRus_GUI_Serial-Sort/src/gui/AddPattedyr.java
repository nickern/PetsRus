...
public class AddPattedyr extends JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 812149487172395941L;
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if(produktnavn.length() != 0 && slektsnavn.length() != 0 && artsnavn.length() != 0 && inkjPrisTF.length() != 0 && prisTF.length() != 0){
							...
							Pattedyr pattedyr = new Pattedyr(produktnavn, inkjPris, pris, (Leverandor)comboBoxLeverandor.getSelectedItem(), slektsnavn, artsnavn);
							
							MainFrame.getPattedyrList().add(pattedyr);
