...
public class AddReptil extends JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -305386362666192203L;
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if(produktnavn.length() != 0 && slektsnavn.length() != 0 && artsnavn.length() != 0 && inkjPrisTF.length() != 0 && prisTF.length() != 0){
							...
							Reptil reptil = new Reptil(produktnavn, inkjPris, pris, (Leverandor)comboBoxLeverandor.getSelectedItem(), slektsnavn, artsnavn);
							
							MainFrame.getReptilList().add(reptil);
